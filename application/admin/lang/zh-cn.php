...
return [
    ...
    'Update state'      => '禁用启用',
    'Admin group'       => '超级管理组',
    'Second group'      => 'zh-cn二级管理组',
    'Third group'       => 'zh-cn三级管理组',
    'Second group 2'    => 'zh-cn二级管理组2',
    'Third group 2'     => 'zh-cn三级管理组2',
    'Dashboard tips'    => '系统中的统计数据、统计报表及重要实时数据',
    'Config tips'       => '可以在此增改系统的设置',
    'Category tips'     => '用于统一管理网站的所有分类',
    'Attachment tips'   => '主要用于管理上传到服务器或第三方存储的数据',
    'Addon tips'        => '可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。',
    'Admin tips'        => '一个管理员可以有多个角色组',
